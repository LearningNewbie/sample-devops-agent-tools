...
## [1.0.0] - 2026-08-21
### Added
- Initial release: Phase 1 MVP (4 of 6 dimensions)
...
- D4: Model Selection Fitness (requires invocation logging enabled)
- D5: Cost Projection (requires invocation logging + usage history)
